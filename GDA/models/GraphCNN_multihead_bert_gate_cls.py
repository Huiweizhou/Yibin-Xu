...
class GraphCNN_multihead_bert_gate_cls(nn.Module):
	def __init__(self, config):
		...
		word_vec_size = 768
		# self.bert = BertModel.from_pretrained('./bio_bert/biobert_v1.1_pubmed')
		self.bert = BertModel.from_pretrained('./bio_bert/bio_bert_base')
	...
	def forward(self, document,document_ner,document_pos,adj_matrix,sen_matrix,pos_matrix_h,pos_matrix_t,node_pos,node_type,node_relative_pos):
		...
		# print (context_output.size())               [1, 197, 128]
		# print (pos_matrix_h.size())                 [17, 17, 3, 197]
		# print (node_pos.size())                     [17, 197]
		...
		return relation_before_softmax_01 #, relation_before_softmax_multi
